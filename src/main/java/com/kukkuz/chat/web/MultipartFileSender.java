...
public class MultipartFileSender {
    ...
    public static MultipartFileSender fromInputStream(InputStream stream, String filename, long length, Date uploadDate, String contentType) {
        MultipartFileSender sender = new MultipartFileSender();
        sender.setInputStream(stream);
        sender.setFileName(filename);
        sender.setLength(length);
        sender.setUploadDate(uploadDate);
    ...
    private MultipartFileSender setFileName(String filename) {
        this.filename = filename;
        return this;
    }
    private MultipartFileSender setLength(Long length) {
        this.length = length;
        return this;
    }
    private MultipartFileSender setUploadDate(Date uploadDate) {
        this.uploadDate = uploadDate;
        return this;
    }

    private MultipartFileSender setContentType(String contentType) {
    ...
    public void serveStreamResource() throws IOException {
        if (response == null || request == null) {
            return;
        }
        ...
        Date lastModifiedObj = this.uploadDate;
